...
//   buffer: {},
//   compatibility: {},
//   files: ["src/assets/meow.mp3", "src/assets/bell.mp3"],
//   proceed: true,
//   source_loop: {},
//   source_once: {},
// };
...
//       audio.source_once[n].noteGrainOn(
//         0,
//         offset,
//         audio.buffer[n].duration - offset
...
//       audio.source_loop[n][audio.compatibility.start](
//         audio.context.currentTime + (audio.buffer[n].duration - offset)
//       );
//     } else {
